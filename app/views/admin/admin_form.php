...
<div class="admin-dashboard-container">
    ...
    <div class="admin-section">
        <form method="POST" action="/Studio-Music/public/index.php?url=admin/saveAdmin" class="studio-form" id="adminForm" onsubmit="return validateAdminForm()">
            <div class="form-group">
                ...
                <small>Format: admin@example.com</small>
            </div>
